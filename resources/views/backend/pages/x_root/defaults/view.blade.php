				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="btn-group float-right">
							<a href="{{ route('#indexFileRoute#') }}" class="btn btn-primary"><i class="fa fa-arrow-left"></i> {{ __('#langFolderDirectory#/default.list') }}</a><a href="{{-- route('admin.#fileName#.edit',$row->slug) --}}" class="btn btn-warning"><i class="fa fa-edit"></i> {{ __('#langFolderDirectory#/default.edit') }}</a>
						</div>
					</div>
