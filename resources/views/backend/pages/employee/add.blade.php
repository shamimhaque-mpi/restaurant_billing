				...
				<form class="form-horizontal" action="{{ route('admin.employee.store') }}" method="post" enctype="multipart/form-data">
					...
					<div class="form-group row">
			            <label class="control-label col-md-3 text-right">
			              ...
			              <span class="text-danger">*</span></label>
			            <div class="col-md-5">
			              <input type="text" id="per_address" class="form-control" name="per_address"  required>
			            </div>
			        </div>
					...
					<div class="form-group row">
			            <label class="control-label col-md-3 text-right">
			              ...
			              <span class="text-danger">*</span></label>
			            <div class="col-md-5">
			              <input type="text" id="pre_address" class="form-control" name="pre_address"  required>
			            </div>
			        </div>
					...
					<div class="form-group row">
			            <label class="control-label col-md-3 text-right">
			              ...
			              <span class="text-danger">*</span></label>
			            <div class="col-md-5">
			              <input type="text" id="nid_no" class="form-control" name="nid_no"  required>
			            </div>
			        </div>
					...
					<div class="form-group row">
			            <label class="control-label col-md-3 text-right">
			              ...
			              <span class="text-danger">*</span></label>
			            <div class="col-md-5">
			              <input type="text" id="gesignation" class="form-control" name="designation"  required>
			            </div>
			        </div>
