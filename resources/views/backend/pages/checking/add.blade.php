...
@section('fav_title', __('backend/checking.add_checking') )
		...
		<div class="card">
			<div class="card-header">
				<div class="row">
					...
					@elseif ('add' == 'add')
					<div class="col-md-6"><h2><i class="{{ 'fa fa-plus-square' }}"></i> {{ __('backend/checking.add_checking') }}</h2></div>
					...
					@elseif ('add' == 'edit')
					<div class="col-md-6"><h2><i class="{{ 'fa fa-plus-square' }}"></i> {{ __('backend/checking.edit_checking') }}</h2></div>
					<div class="col-md-6"><a href="{{ route('admin.checking.index') }}" class="float-right btn btn-primary"><i class="fa fa-arrow-left"></i> {{ __('backend/default.list') }}</a></div>
					@endif
