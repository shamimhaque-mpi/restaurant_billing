			...
			<div class="card-body">
				...
				<form action="{{ route('admin.sms.submit_send_sms') }}" method="post">
					...
					<div class="row">
						...
						<div class="col-md-8">
							<div data-simplebar class="br-4" style="height: 200px; border: 2px solid #ced4da;">
								<table class="table table-bordered br-2 mb-0">
									...
									@endphp
									<tr>
										<td><input type="checkbox" class="form-control" name="mobile_no[]" value="{{ $value->customer_mobile }}" checked></td>
